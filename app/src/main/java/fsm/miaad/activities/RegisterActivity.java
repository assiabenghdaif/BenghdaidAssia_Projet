                ...
                if(password.getText().toString().equals(passwordCon.getText().toString())){
                    if(len>=8){
                        ...
                        if (cursor.moveToFirst()) {
                            do {
                                if (cursor.getString(3).equals(email.getText().toString()) == true) {
                                    result = true;
                                    break;
                                }
...
//                    error.setText();
                            ...
                            User user = new User(fname.getText().toString(), lname.getText().toString(), email.getText().toString(), password.getText().toString());
//                    error.setText(email.getText().toString());
