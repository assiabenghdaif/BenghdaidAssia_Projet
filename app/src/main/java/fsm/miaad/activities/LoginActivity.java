...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextView btn,error,forgotPassword;
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cursor.moveToFirst()) {
                    do{
                        if(cursor.getString(4).equals(password.getText().toString()) && cursor.getString(3).equals(email.getText().toString())) {
                            result=true;
                            break;
                ...
                if(result==true){
                    ...
                    String emailConnect= email.getText().toString();
